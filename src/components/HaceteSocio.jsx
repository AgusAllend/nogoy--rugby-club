...
const HaceteSocio = () => {
  return (
    <div id="HaceteSocio" className="relative flex min-h-[70vh] min-w-full w-full items-center justify-center bg-[url('public/images/foto7.JPG')] bg-cover bg-center bg-fixed">
